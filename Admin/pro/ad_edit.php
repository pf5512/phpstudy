...
font-size:16px;font-family:Microsoft Yahei;
 text-align:center;margin-top:10px;"> 
  ...
  $datalist4 = $adlist->get_product_data('0004');
  ?>
  <div class="bform" style="display:block;margin-top:20px;height:350px; background-color:#c9c9c9;" >
  <span style="margin-left:33px;display:block;color:black;height:40px;line-height:40px;">
   ...
   <form class="sform-img" style="margin-top:15px; height:80px;" enctype = "multipart/form-data" action="ad_edityes_img.php?type=0001"  method="post">
   ...
   <div class="bform" style="margin-top:20px;height:350px; background-color:#c9c9c9;" >
  <span style="margin-left:33px;display:block;color:black;height:40px;line-height:40px;">
       图2编辑
  </span>  
   ...
   <form class="sform-img" style="margin-top:15px; height:80px;" enctype = "multipart/form-data" action="ad_edityes_img.php?type=0002"  method="post">
	  <span style="display:block;clear:left;float:left;margin-left:33px;margin-top:20px;">图片更换:</span>
	<input  style="display:block;clear:left;float:left;margin-left:33px;color:white;border:1px solid black;background-color:white;" type="file" name="MyFile"/>
	 <input   style="display:block;width:70px;height:25px;clear:left;float:left;margin-left:33px;font-size:13px;font-family:Microsoft Yahei;margin-top:5px;" type="submit" value=" 上传 " />
    </form>
  ...
  <span style="margin-left:33px;display:block;color:black;height:40px;line-height:40px;">
   ...
   <form class="sform-img" style="margin-top:15px; height:80px;" enctype = "multipart/form-data" action="ad_edityes_img.php?type=0003"  method="post">
	<span style="display:block;clear:left;float:left;margin-left:33px;margin-top:20px;">图片更换:</span>
	<input  style="display:block;clear:left;float:left;margin-left:33px;color:white;border:1px solid black;background-color:white;" type="file" name="MyFile"/>
	 <input   style="display:block;width:70px;height:25px;clear:left;float:left;margin-left:33px;font-size:13px;font-family:Microsoft Yahei;margin-top:5px;" type="submit" value=" 上传 " />
    </form>
  ...
  <span style="margin-left:33px;display:block;color:black;height:40px;line-height:40px;">
    ...
    <span style="display:block;clear:left;float:left;margin-left:33px;">链接:&nbsp;</span>
      <input style="display:block;clear:left;float:left;margin-left:33px;width:400px;"  value="<?php echo $datalist4[2];?>" name="linkk" type="text"/>
 
      <span style="display:block;clear:left;float:left;margin-left:33px;">文字描述:&nbsp;</span>

      <textarea cols="80" style="display:block;clear:left;float:left;margin-left:33px;height:100px;" id="editor1" name="contentt" rows="20"><?php echo  $datalist4[1];?></textarea>
   ...
   <form class="sform-img" style="margin-top:15px; height:80px;" enctype = "multipart/form-data" action="ad_edityes_img.php?type=0004"  method="post">
	 <span style="display:block;clear:left;float:left;margin-left:33px;margin-top:20px;">图片更换:</span>
	<input  style="display:block;clear:left;float:left;margin-left:33px;color:white;border:1px solid black;background-color:white;" type="file" name="MyFile"/>
	 <input   style="display:block;width:70px;height:25px;clear:left;float:left;margin-left:33px;font-size:13px;font-family:Microsoft Yahei;margin-top:5px;" type="submit" value=" 上传 " />
    </form>
