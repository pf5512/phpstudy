...
$typekey = $_GET['type'];
$data_list = $type_list->get_data($typekey);
//$pathname = 'pro-img/type/'.$typekey.'.jpg';


$typekey1 = Pinyin($typekey);
$typekey2 = strtr($typekey1,"/", "-");
$pathname = 'pro-img/type/'.$typekey2.'.jpg';
?>
...
<?php 
  ...
  if (move_uploaded_file($_FILES['MyFile']['tmp_name'], $pathname)) { 
  	?> <div class="hint-word"> 
	<span > &nbsp;图片添加成功</span>
	<a id="fenlei-a-r" href="type_edityes_img.php?type=<?php echo $typekey;?>" class="navi-all" id="navi0">返回&nbsp;</a> 
	</div>
	<?php 
  }
  else { 
