...
<meta   http-equiv=refresh   content= '1; url=brand_edit_single.php?type=<?php echo $brankey;?> '>
...
<?php 
  if( $brand_list->edit_pro($brankey,$content) )
{
	?>
	<br> 
	<div class="hint-word"> 
	<span > &nbsp; <?php echo "   品牌描述修改成功"; ?> </span>
	<a id="fenlei-a-r" href="brand_edit_single.php?type=<?php echo $brankey;?>" class="navi-all" id="navi0">返回&nbsp;</a> 
	</div>
