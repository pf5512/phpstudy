...
$brankey1 = Pinyin($brankey);
$brankey2 = strtr($brankey1,"/", "-");
$pathname = 'pro-img/suolue/'.$brankey2.'.jpg';
...
<?php 
  ...
  if (move_uploaded_file($_FILES['MyFile']['tmp_name'], $pathname)) { 
  	?> <div class="hint-word"> 
	<span > &nbsp;图片添加成功</span>
	<a id="fenlei-a-r" href="brand_edityes_img.php?type=<?php echo $brankey;?>" class="navi-all" id="navi0">返回&nbsp;</a> 
	</div>
	<?php 
  }
  else { 
