...
//$temp_pro ->add_pro( '001','公司路线',0,0,0,'1920',"路线标题1","saffefgweg啊覅请问ifa王府井全五分 王分区分换");
//$temp_pro ->add_pro( '002','行业路线',0,0,0,'1919',"路线标题1","saffefgweg啊覅请问ifa王府井全五分 王分区分换");
...
<?php include('../menu.php'); ?>
  ...
  <span style="display:block; width:700px;  margin:0 auto;font-size:16px;font-weight:bold;font-family:Microsoft Yahei;text-align:center;margin-top:150px;"> 
      <a href="product-edit.php?type=1_1_1_1 " style="background-color:black;color:white;">&nbsp;&nbsp;路线管理&nbsp;&nbsp;</a>
      <a href="fenlei1.php?type=0" style="background-color:black;color:white;">&nbsp;&nbsp;路线添加&nbsp;&nbsp;</a>
      <br><br>
  </span>
