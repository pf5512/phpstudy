...
<div class="head"><!-- logo+导航模块，用语定义logo+导航的居中 -->
    ...
    <a  href="../filss/product-list.php?type=1_1_1_1" class="navi-all-down">EQUIPMENTS</a>
     ...
     <img class="navi-beside" alt="" src="navi-img/navi-beside.jpg"><!-- logo模块 -->
    <div class="navi-all" >
    <a  href="../line/product-list.php?type=1_1_1_1" class="navi-all-down">MATERIALS</a>
    </div>
     <img class="navi-beside" alt="" src="navi-img/navi-beside.jpg"><!-- logo模块 -->
    <div class="navi-all" >
    ...
    <img class="navi-beside" alt="" src="navi-img/navi-beside.jpg"><!-- logo模块 -->
    <div class="navi-all" >
    <a  href="../line2/product-list.php?type=1_1_1_1" class="navi-all-down">line</a>
    </div>
</div>
</div>
</div>

<img class="banner-img" alt=""  src="line-img/line-banner.jpg">
<img class="banner-title" alt=""  src="line-img/line-banner-title.jpg">
   <div id="pro-all">
       ...
       ?>
            ...
            <img style="clear:left; float:left;" alt="" src="line-img/line-cointent-jiange.jpg">
