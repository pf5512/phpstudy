...
if(!empty($userLang)) 
{
	$userLang = eregi_replace('[^a-z0-9]','',$userLang);
}

if( !empty($userLang) && file_exists(DEDEINC.'/lang/'.$userLang.'.datalistcp.utf8.php') )
{
	require_once(DEDEINC.'/lang/'.$userLang.'.datalistcp.utf8.php');
}
else
{
	$lang_pre_page = '上页';
