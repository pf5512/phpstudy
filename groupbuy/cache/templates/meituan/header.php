...
<body>
<? if($is_mobile ) { ?>
<script>window.location.href="?mod=downapp_mobile"; alert("dwd")</script>
<?=$is_mobile?>
<? } ?>
<div class="exp">
<div class="header">
...
<? if($unms) { ?>
 style="margin:0;"
<? } ?>
 title="邮件订阅"><i class="icon icon-email"></i>邮件订阅</a>
</li>
<li class="mobile-info__item">
...
<li class="mobile-info__item" id="change-skin" onclick="ShowHideDiv()"
<? if($unms) { ?>
 style="display:none;"
<? } ?>
 title="更换界面">
...
<a class="cart-a" href="?mod=seller&code=cart">
<i class="ico-cart"></i>
<span>购物车<i class="R12">0</i>件</span>
...
<li>
<div class="image"><a target="_blank" href="index.php?view=<?=$row['id']?>"><img src="<?=$row['img_src']?>"> </a></div>
<div class="right">
<h4><a target="_blank" href="index.php?view=<?=$row['id']?>"><?=$row['name']?></a></h4>
<em class="price">&yen;<?=$row['nowprice']?></em> <em class="cart-list--del">删除</em>
</div> 
</li>
<? } } ?>
<li>
<div class="image"><a target="_blank" href="index.php?view=227"><img src="static/images/imager.404.jpg"></a>   </div>
<div class="right"><h4>【天城路沿线】80后自助餐厅</h4><em class="price">&yen;39.90</em> <em class="cart-list--del">删除</em></div> 
</li>
<? if($products) { ?>
<li class="cart-list-link"><a class="b_btn s_btn" href='javascript:;' onclick="">查看我的购物车</a></li>
