...
class miscmodel {
	...
	function dfopen2($url, $limit = 0, $post = '', $cookie = '', $bysocket = FALSE, $ip = '', $timeout = 3, $block = TRUE, $encodetype  = 'URLENCODE') {
	...
	function dfopen($url, $limit = 0, $post = '', $cookie = '', $bysocket = FALSE	, $ip = '', $timeout = 3, $block = TRUE, $encodetype  = 'URLENCODE') {
